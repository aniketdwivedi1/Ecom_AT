...
public class Courses {
	...
	public static void main(String[] args) {
		...
		//Object creation
		Trainer Trainer1 = new Trainer("Arpit",32,"Java",8);
		Trainer Trainer2 = new Trainer("Sania",29,"Selenium",4);
		Trainer Trainer3 = new Trainer("Rahul",30,"SQL",7);
		Trainer Trainer4 = new Trainer("Vikas",27,"Framework",12);
